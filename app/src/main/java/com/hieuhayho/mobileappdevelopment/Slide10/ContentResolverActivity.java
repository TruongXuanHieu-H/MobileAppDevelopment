package com.hieuhayho.mobileappdevelopment.Slide10;
...
/*
    Vì User Dictionary không còn có thể truy cập từ android API 25
    nên bản demo này sẽ thao tác vào bộ sưu tập hình ảnh thay vì
    dữ liệu được lưu trữ trong User Dictionary
 */
